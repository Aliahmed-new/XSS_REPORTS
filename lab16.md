...
## Title
Refelcted (XSS) in search parameter

## Vulnerability Type
Reflected XSS

## Summary
The kzlabs.com/punishment page has an XSS vulnerability in search parameter . whatever you type into the it gets embedded raw into a page response with no sanitization, By injecting an HTML tag with an event handler arbitary JavaScript executes immediately on page load and the popup fires.


## Vulnerable Endpoint
```
http://kzlabs.com/16.php
```

## Steps to Reproduce
1. Go to the following crafted URL
```
http://kzlabs.com/16.php?search=%22%3E%3Cscript%3Ealert%281%29%3C%2Fscript%3E
```
...
<img width="1482" height="628" alt="image" src="https://github.com/user-attachments/assets/31b5834f-bdf8-462b-a74a-98fa76e772ea" />
