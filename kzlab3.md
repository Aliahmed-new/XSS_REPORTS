...
## Vulnerable Endpoint
```
http://kzlabs.com/3.php
```

## Steps to Reproduce
1. Go to the following URL
```
 http://kzlabs.com/2.php?Lname=
```
...
<img width="1686" height="630" alt="image" src="https://github.com/user-attachments/assets/90c1376a-2e2d-47bc-aed0-8efcd852c549" />
...
<img width="1485" height="815" alt="image" src="https://github.com/user-attachments/assets/d9b20730-04d2-4bb6-97e5-562e03902a6b" />
