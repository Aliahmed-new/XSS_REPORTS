...
2.click on Trip History and click on  View invoice

3. Observe the below URL

```
http://kzlabs.in/702.php?action=trip&id=41

```

4. In the id parameter change the number to 41 or 42
...
<img width="1662" height="926" alt="image" src="https://github.com/user-attachments/assets/e7bc9fd2-b7b9-4328-9da6-e91aad26b74e" />
